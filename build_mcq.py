...
# ========== 配置 ==========
INPUT_CSV = Path("splits/dev.csv")   # 改成 splits/test_full.csv 就生成 full
OUT_DIR = Path("mcq_out")
SEED = 42

N_CHOICES = 4              # 1 correct + 3 distractors
N_QUESTIONS = 2000         # 每个方向生成多少题；0 或 None 表示全量（不建议）
DISTRACTOR_STRATEGY = "easy"   # "easy" 或 "hardlex"
HARDLEX_CANDIDATE_POOL = 200   # hardlex: 候选池越大越难、也越慢
# ==========================
